    ...
    <div style={{ marginBottom: 16 }}>
      ...
      <input
        ...
        style={{
          ...
          border: `1.5px solid ${hasErr ? "#E74C3C" : "#E2DDD8"}`,
          fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#1C1917",
          outline: "none", background: hasErr ? "#FFF5F5" : "#FAFAFA",
          boxSizing: "border-box",
        }}
        onFocus={(ev) => (ev.target.style.borderColor = hasErr ? "#E74C3C" : "#6B5B45")}
        onBlur={(ev)  => (ev.target.style.borderColor = hasErr ? "#E74C3C" : "#E2DDD8")}
      />
      {hasErr && (
    ...
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 8, justifyContent: "flex-end" }}>
        ...
        <button type="submit" style={{
          ...
          boxShadow: "0 4px 16px rgba(107,91,69,0.25)",
        }}>
          {submitLabel}
        </button>
      </div>
